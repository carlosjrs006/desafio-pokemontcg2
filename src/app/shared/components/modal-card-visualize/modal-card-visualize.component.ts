...
@Component({
  selector: 'app-modal-card-visualize',
  templateUrl: './modal-card-visualize.component.html',
  styleUrls: ['./modal-card-visualize.component.scss']
})
export class ModalCardVisualizeComponent {
  constructor(private dialog: MatDialog,@Inject(MAT_DIALOG_DATA) public  data: {newDeck:Deck}, private dialogRef: MatDialogRef<ModalCardVisualizeComponent>) {
  ...
  saveDeck(){
    this.dialogRef.close("saveDeck");
  }

  excluirDeck(){
    this.dialogRef.close("excluirDeck");
  }
}
