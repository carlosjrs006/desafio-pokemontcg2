...
@Component({
  selector: 'app-modal-deck',
  templateUrl: './modal-deck.component.html',
  styleUrls: ['./modal-deck.component.scss']
})
export class ModalDeckComponent {
  constructor(private route: Router, @Inject(MAT_DIALOG_DATA) public data: {deck: any}, private dialogRef: MatDialogRef<ModalDeckComponent>, private globalContext: GlobalContextService) {}
  ...
  deleteDeck(){
    this.globalContext.removeDeckByName(this.data.deck.name);
